...
pub fn run() -> Result<()> {
    ...
    println!("\n── Output ──────────────────────────────────────────────────────────────────");
    println!("By default, pesto places the .nzb next to the uploaded file.");
    ...
    if nzb_dir.is_empty() {
        toml.push_str("# nzb_dir omitted: .nzb is placed next to the uploaded file.\n");
    } else {
        toml.push_str(&format!("nzb_dir = \"{}\"\n", esc(&nzb_dir)));
    }
    if nfo {
        toml.push_str("nfo = true\n");
    } else {
        toml.push_str("# nfo = false\n");
    }
