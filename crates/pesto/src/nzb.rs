...
/// `--obfuscate` mode: obfuscation only scrambles the `Subject:`
...
/// scene/P2P release.
///
/// `light` remains discoverable because its wire Subject and yEnc name are
/// equal; that deliberate wire fingerprint does not make the authoritative
/// NZB generated by pesto discard the client path.
///
